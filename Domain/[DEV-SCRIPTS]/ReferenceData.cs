...
namespace Domain
{
    public class ReferenceData : IReferenceData
    {
        ...
        public async Task Create()
        {
            await new[]
            {
                new InputDataType { Name = "Generic" },
                new InputDataType { Name = "Weight" , InputControlInfo = "(kg)" },
                new InputDataType { Name = "Meter", InputControlInfo = "(m)" },
                new InputDataType { Name = "Millimeter" , InputControlInfo = "(mm)"},
            }.Do(Create);
